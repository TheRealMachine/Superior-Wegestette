...
class Button:
    def __init__(self, x, y, width, height, fg, bg, content, fontsize):
        self.font = pygame.font.Font('BAUHS93.TTF', fontsize)
...
class Time(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.time_image.get_sprite(0,0,self.width,self.height)
...
class Oak(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.oak_image.get_sprite(0,0,self.width,self.height)

        self.rect = self.image.get_rect()
        self.rect.x = self.x
        self.rect.y = self.y 

class Spruce(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.spruce_image.get_sprite(0,0,self.width,self.height)
...
class Lava(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.lava_image.get_sprite(0,0,self.width,self.height)

        self.rect = self.image.get_rect()
        self.rect.x = self.x
        self.rect.y = self.y 

class Grassdown(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.grassdown_image.get_sprite(0,0,self.width,self.height)

        self.rect = self.image.get_rect()
        self.rect.x = self.x
        self.rect.y = self.y 

class Stonedown(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.stonedown_image.get_sprite(0,0,self.width,self.height)
...
class Stone(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.stone_image.get_sprite(0,0,self.width,self.height)

        self.rect = self.image.get_rect()
        self.rect.x = self.x
        self.rect.y = self.y 

class Haydown(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.haydown_image.get_sprite(502,317,self.width,self.height)
...
class Hay(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.hay_image.get_sprite(505,288,self.width,self.height)
...
class Forestground(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.forestgrass_image.get_sprite(256,352,self.width,self.height)

        self.rect = self.image.get_rect()
        self.rect.x = self.x
        self.rect.y = self.y 

class Forestgrounddown(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.forestgrassdown_image.get_sprite(0,0,self.width,self.height)

        self.rect = self.image.get_rect()
        self.rect.x = self.x
        self.rect.y = self.y 

class Sakuratree(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.sakura_image.get_sprite(0,0,self.width,self.height)
